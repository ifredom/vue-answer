        ...
        <section class="container">
            <section class="card" v-for="(item,index) in cardList" :key="'card'+index">
                ...
                <div class="card-content">
                    <span class="content-title"><img src="./../../image/books/timg.jpg" width="60" height="80" /></span>
...
export default {
    data() {
        return {
            cardList: [
                { username: '艾泽拉斯大陆秘史', lang: 'PHP', conver: 'php为什么是世界上最好的语言？', content: '1995年6月8日，机智的小伙儿拉斯姆斯·勒多夫将PHP/FI公开发布，这位说：世界是PHP的.' },
                { username: '区块链投资', lang: 'javascript', conver: '灵活又矫健的javascipt？', content: '1995年，当时在网景公司就职的布兰登·艾克花了10天时间写了这个编程语言，此时web开发者的内心是...' },
                { username: '百年孤独', lang: 'java', conver: '尔统统是rb', content: '且看下回分解了~~' },
                { username: '销售技巧快速进阶办法', lang: 'java', conver: '尔统统是rb', content: '且看下回分解了~~' },
                { username: '震惊娱乐圈的大事件', lang: 'java', conver: '尔统统是rb', content: '且看下回分解了~~' },
                { username: '世界的另一面', lang: 'java', conver: '尔统统是rb', content: '且看下回分解了~~' }
            ]
        }
    },
    computed: {
