        ...
        <section class="container">
            <section class="card" v-for="(item,index) in cardList" :key="'card'+index">
                ...
                <div class="card-content">
                    ...
                    <div class="content-detail"><span class="content-value">#{{item.conver}}</span>{{item.content}}</div>
                </div>
                <figure class="card-option">
                    <div class="option-section option-section-left">
                        <i class="icon iconfont icon-dianzan"> <em>{{item.zan}}</em> </i>
      ...
      cardList: [
        {
          ...
          conver: "最受关注",
          zan: 101,
          content: "我来过，我很乖。有一个小女孩，她的名字叫佘艳，她有一双亮晶晶的大眼睛和一颗透亮的童心。她是一个孤儿，她在这个世界上只活了8年"
        },
        {
          username: "简书",
          lang: "javascript",
          conver: "最多阅读",
          zan: 6,
          content: "每个人都有一道伤口，或深或浅，盖上布，以为不存在。我把最殷红的鲜血涂在那里。你不懂我，我不怪你。"
        },
        {
          username: "github",
          lang: "java",
          conver: "最具价值",
          zan: 161,
          content: "每个人都有一场爱恋，用心、用情、用力，感动也感伤。我把最炙热的心情藏在那里。你不懂我，我不怪你。每个人都有一行眼泪，"
        },
        {
          username: "掘金",
          lang: "java",
