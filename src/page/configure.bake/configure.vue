<template>
  <div class="container">
    ...
    <p style="font-size:15px;">优化方向 https://didi.github.io/cube-ui/example/#/swipe/custom</p>
    <transition-group name="swipe" tag="ul">
      <li class="list-item " v-for="(item,index) in list " data-type="0" :key="index+'slide'">
        ...
        <div class="ta-swiper-btn delete" @click="deleteItem" :data-index="index">删除</div>
      </li>
    </transition-group>
  </div>
</template>
