<template>
  <header class="ta-header" :class="{ 'ta-fixed': fixed,'otherStyle':otherStyle }">
    <div class="ta-left" :class="positionClass" @click="$router.back()">
      <span class="backimg left-back1"></span>
      <!-- <slot name="left"></slot> -->
    </div>
...
.ta-header .ta-left img, .ta-header .ta-right img, .ta-header .ta-back img {
  margin-top: -3px;
  width: 100%;
  height: 100%;
...
.ta-header .ta-left span.backimg {
...
.ta-header .ta-left span.left-back1 {
  background: url('./../../image/common/tips.png') no-repeat center;
